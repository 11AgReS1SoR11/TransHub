...
{
    std::vector<int> a = {3, 3}; // storages   sum(a) = 6
    std::vector<int> b = {1, 2, 1}; // clients   sum(b) = 4
    std::vector<int> d = {1, 1, 1, 1, 1}; // couriers   sum(d) = 5 => cannot draw conclusions about the optimality of the naive solution
...
void TestClass::test_case2()
{
    ...
    // std::vector<int> a = {1, 4, 4, 5, 3}; // storages
    // std::vector<int> b = {3, 2, 4, 2}; // clients
    // std::vector<int> d = {1, 1, 1, 1, 1, 1, 1}; // couriers
    // // matrix storages-clients
